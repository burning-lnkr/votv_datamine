...
| Result | Recipe | Blueprint | Reversible |
| --- | --- | --- | --- |
| - "Kerfur" blue ([kerfus](props.md#kerfus)) | - Kerfur parts x3 ([kerfurParts_0](props.md#kerfurparts0))<br>- Kerfur wheel ([kerfusWheel](props.md#kerfuswheel))<br>- Kerfur color (blue) ([kerfCol_0](props.md#kerfcol0)) | N/A | ❌ |
| - "Kerfur" custom ([kerfus_g](props.md#kerfusg)) | - "Kerfur" blue ([kerfus](props.md#kerfus))<br>- "Kerfur" pink ([kerfus_0](props.md#kerfus0))<br>- "Kerfur" red ([kerfus_1](props.md#kerfus1)) | N/A | ✅ |
| - "Kerfur" pink ([kerfus_0](props.md#kerfus0)) | - Kerfur parts x3 ([kerfurParts_0](props.md#kerfurparts0))<br>- Kerfur wheel ([kerfusWheel](props.md#kerfuswheel))<br>- Kerfur color (pink) ([kerfCol_1](props.md#kerfcol1)) | N/A | ❌ |
| - "Kerfur" red ([kerfus_1](props.md#kerfus1)) | - Kerfur parts x3 ([kerfurParts_0](props.md#kerfurparts0))<br>- Kerfur wheel ([kerfusWheel](props.md#kerfuswheel))<br>- Kerfur color (red) ([kerfCol_2](props.md#kerfcol2)) | N/A | ❌ |
| - An unknown doll ([argemia_15](props.md#argemia15)) | - Kerfur-O (no color) ([kerfurO_nc](props.md#kerfuronc))<br>- An unknown doll ([argemia](props.md#argemia))<br>- An unknown doll ([argemia_0](props.md#argemia0))<br>- An unknown doll ([argemia_1](props.md#argemia1)) | N/A | ✅ |
| - Antibreather plush ([abplush_0](props.md#abplush0)) | - Kerfur-O (no color) ([kerfurO_nc](props.md#kerfuronc))<br>- Fungus ([shroom](props.md#shroom))<br>- Fungus ([shroom_2](props.md#shroom2))<br>- Fungus ([shroom_3](props.md#shroom3))<br>- Fungus ([shroom_4](props.md#shroom4))<br>- Fungus ([shroom_5](props.md#shroom5))<br>- Fungus ([shroom_6](props.md#shroom6))<br>- Fungus ([shroom_7](props.md#shroom7))<br>- Antibreather plush ([abplush](props.md#abplush)) | N/A | ✅ |
| - Antique watch ([watches](props.md#watches))<br>- Screwdriver ([tool_sc](props.md#toolsc)) | - Old watch ([j_watches](props.md#jwatches))<br>- Screwdriver ([tool_sc](props.md#toolsc)) | N/A | ❌ |
| - Broomba ([roomba_m](props.md#roombam)) | - Broomba ([roomba](props.md#roomba))<br>- dingus ([dingus](props.md#dingus)) | N/A | ❌ |
| - Burger ([burger](props.md#burger)) | - Burger buns ([burgerBuns](props.md#burgerbuns))<br>- Burger patty (cooked) ([patty_c](props.md#pattyc))<br>- Tomato slice ([tomato_sl_0](props.md#tomatosl0))<br>- Cheese slice ([cheeses](props.md#cheeses)) | N/A | ❌ |
| - Burger patty (raw) ([patty_r](props.md#pattyr)) | - Sausage (raw) ([sausage_r](props.md#sausager)) | N/A | ❌ |
| - Cheese ([cheese](props.md#cheese)) | - Cheese cube x10 ([cheesec](props.md#cheesec)) | N/A | ✅ |
| - Cheese wheel ([cheesew](props.md#cheesew)) | - Cheese x8 ([cheese](props.md#cheese)) | N/A | ✅ |
| - cig_f x3 ([cig_f](props.md#cigf)) | - Cig pack ([cigp](props.md#cigp)) | N/A | ❌ |
| - Clocks ([clocks](props.md#clocks)) | - Drive x2 ([drive](props.md#drive)) | N/A | ✅ |
| - Coal ([coal](props.md#coal)) | - Coal piece x4 ([coal_s](props.md#coals)) | N/A | ❌ |
| - Coal piece x4 ([coal_s](props.md#coals)) | - Coal ([coal](props.md#coal)) | N/A | ❌ |
| - Compressed radioactive material ([radCube](props.md#radcube))<br>- Gas welder ([tool_gw](props.md#toolgw)) | - Radioactive crystal shard x4 ([radCrystal](props.md#radcrystal))<br>- Gas welder ([tool_gw](props.md#toolgw)) | N/A | ❌ |
| - Cooler ([miner_fan](props.md#minerfan)) | - Accumulator battery x2 ([batt_a](props.md#batta))<br>- Metal scrap x4 ([scrap_metal](props.md#scrapmetal))<br>- Electronic scrap x4 ([scrap_elec](props.md#scrapelec)) | N/A | ❌ |
| - Crossbow ([fungun_crossbow](props.md#funguncrossbow)) | - Crossbow piece ([xbowp_0](props.md#xbowp0))<br>- Crossbow piece ([xbowp_1](props.md#xbowp1))<br>- Crossbow piece ([xbowp_2](props.md#xbowp2))<br>- Crossbow piece ([xbowp_3](props.md#xbowp3)) | xbow | ❌ |
| - Dough bun (burger) ([doughbun_b](props.md#doughbunb)) | - Dough bun (hotdog) ([doughbun_h](props.md#doughbunh)) | N/A | ❌ |
| - Dough bun (hotdog) ([doughbun_h](props.md#doughbunh)) | - Dough bun (burger) ([doughbun_b](props.md#doughbunb)) | N/A | ❌ |
| - Drive x4 ([drive](props.md#drive)) | - Metal scrap ([scrap_metal](props.md#scrapmetal))<br>- Electronic scrap ([scrap_elec](props.md#scrapelec)) | N/A | ❌ |
| - Electronic scrap ([scrap_elec](props.md#scrapelec)) | - Items tagged gelec x4 ([gelec](props_by_tags.md#gelec)) | N/A | ❌ |
| - Electronic scrap ([scrap_elec](props.md#scrapelec)) | - Drive x4 ([drive](props.md#drive)) | N/A | ❌ |
| - Erie plush ([eriePlush_0](props.md#erieplush0)) | - Kerfur-O (no color) ([kerfurO_nc](props.md#kerfuronc))<br>- Erie plush ([eriePlush](props.md#erieplush)) | N/A | ✅ |
| - Erie plush ([eriePlushV4_0](props.md#erieplushv40)) | - Erie plush ([eriePlush_0](props.md#erieplush0))<br>- Cheese wheel ([cheesew](props.md#cheesew)) | N/A | ✅ |
| - Fax\printer (WIP) ([fax](props.md#fax)) | - Burger ([burger](props.md#burger)) | rewrew | ❌ |
| - Fish bait x3 ([fbait_7](props.md#fbait7))<br>- Fish bait x2 ([fbait_8](props.md#fbait8))<br>- Fish bait ([fbait_9](props.md#fbait9))<br>- Fish bait ([fbait_10](props.md#fbait10)) | - MRE ([mre](props.md#mre)) | N/A | ❌ |
| - Fishing rod ([fishingrod_0](props.md#fishingrod0)) | - Fishing rod part ([p_fishrod_0](props.md#pfishrod0))<br>- Fishing rod part ([p_fishrod_1](props.md#pfishrod1))<br>- Fishing rod part ([p_fishrod_2](props.md#pfishrod2))<br>- Fishing rod part ([p_fishrod_3](props.md#pfishrod3))<br>- Fishing rod part ([p_fishrod_4](props.md#pfishrod4))<br>- Fishing rod part ([p_fishrod_5](props.md#pfishrod5))<br>- Fishing rod part ([p_fishrod_6](props.md#pfishrod6)) | N/A | ❌ |
| - Furfur plush ([wendplush_0](props.md#wendplush0)) | - Kerfur-O (no color) ([kerfurO_nc](props.md#kerfuronc))<br>- Furfur plush ([wendplush](props.md#wendplush))<br>- Bone x4 ([g_bone_0](props.md#gbone0))<br>- Bone ([g_bone_1](props.md#gbone1))<br>- Bone x4 ([g_bone_2](props.md#gbone2))<br>- Bone x3 ([g_bone_3](props.md#gbone3)) | N/A | ✅ |
| - Gas can ([gascan](props.md#gascan)) | - Metal scrap x2 ([scrap_metal](props.md#scrapmetal)) | N/A | ❌ |
...
| - Kerfur-O (no color) ([kerfurO_nc](props.md#kerfuronc)) | - Kerfur-O head ([kerfognc_5](props.md#kerfognc5))<br>- Kerfur-O chest ([kerfognc_2](props.md#kerfognc2))<br>- Kerfur-O pelvis ([kerfognc_1](props.md#kerfognc1))<br>- Kerfur-O arm x2 ([kerfognc_0](props.md#kerfognc0))<br>- Kerfur-O leg x2 ([kerfognc_6](props.md#kerfognc6)) | N/A | ✅ |
...
| - pipebomb ([pipebomb](props.md#pipebomb)) | - Bottle with gasoline x2 ([beer_g](props.md#beerg))<br>- Metal scrap ([scrap_metal](props.md#scrapmetal))<br>- Plastic scrap ([scrap_plastic](props.md#scrapplastic)) | N/A | ❌ |
...
| - Wooden scrap ([scrap_wood](props.md#scrapwood)) | - Items tagged gwood x4 ([gwood](props_by_tags.md#gwood)) | N/A | ❌ |
